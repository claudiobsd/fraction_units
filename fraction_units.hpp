...
public:
    ...
    friend _CONSTEXPR_ inline auto operator*(const long double lhs, const RQty& rhs);
    friend _CONSTEXPR_ inline auto operator*(const RQty& lhs, const long double rhs);
